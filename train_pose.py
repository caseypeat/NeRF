...
if __name__ == '__main__':
    ...
    optimizer = torch.optim.Adam([{'params': [R, T]}], lr=1e-4)
    ...
    for i in tqdm(range(500)):
        ...
        K = model_b.intrinsics[n].to('cuda')
        E = model_b.extrinsics[n].to('cuda')
        ...
        z_vals_log, z_vals = model_b.efficient_sampling(rays_o, rays_d, cfg.renderer.importance_steps)
        ...
        alpha = 1 - torch.exp(-sigmas_b * delta)  # [N_rays, N_samples]
